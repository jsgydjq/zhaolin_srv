...
def analyze(content):
    ...
    for item in items:
        try:
            ...
            AppInfo.objects.create(appname=base64.encodestring(item[0].encode('utf-8')), icon_url=item[2], descript=base64.encodestring(item[3].encode('utf-8')), detail_url=item[4], star_rate=item[5], down_count=item[6], down_url=item[7], app_type=0, from_user=False) 
